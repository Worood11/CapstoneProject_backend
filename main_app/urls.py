...
from .views import Home , BookstoresIndex , BookstoreDetail , ReviewsIndex , ReviewDetail , CreateUserView , LoginView , EventsIndex , EventDetail, EventListCreateView  , VerifyUserView
urlpatterns = [
